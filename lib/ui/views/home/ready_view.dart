...
class _ReadyViewState extends State<ReadyView> {
  ...
  Widget build(BuildContext context) {
    return BaseView<ReadyViewModel>(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Container(
                                            margin:
                                                const EdgeInsets.only(left: 10),
                                            child:
                                                widget.friendUser.name == null
                                                    ? Text(
                                                        'No ha seleccionado a ningún amigo',
                                                        style: TextStyle(
                                                            fontWeight:
                                                                FontWeight.bold,
                                                            fontSize: 14.0),
                                      ...
                                      Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          FlatButton(
                                            ...
                                            onPressed: (widget.friendUser ==
                                                        null ||
                                                    widget.friendUser.total ==
                                                        0)
                                                ? null
                                                : () async {
                                                    productsModal(
